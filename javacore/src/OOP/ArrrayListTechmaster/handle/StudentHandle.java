...
public class StudentHandle {
    ...
    public void addStudent(Scanner scanner, ArrayList<Student> students, Student student){
    ...
    public void editStudentByID(Scanner scanner,ArrayList<Student> students,Student student){
    ...
    public void deleteStudent(Scanner scanner,ArrayList<Student> students,Student student){
